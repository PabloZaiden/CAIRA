...
# =============================================================================
# These resources simulate reusable capability-host infrastructure for private
# validation scenarios that consume existing host resources instead of creating them inline.
