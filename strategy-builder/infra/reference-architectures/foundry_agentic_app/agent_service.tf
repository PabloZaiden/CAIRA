# This is the smallest app-service layer. If a derived implementation only needs an
# agent container, it can keep this file plus application_platform.tf and remove the
# API/frontend files and matching outputs.
