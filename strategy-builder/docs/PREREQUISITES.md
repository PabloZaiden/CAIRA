...
The repository already contains the CAIRA foundation reference architecture and reusable modules under `infra/`. No extra CAIRA checkout, version pin file, or bootstrap clone step is required.
