...
| `task strategy:deploy -- deployment-strategies/<reference-architecture>/<name>`        | Deploy one generated strategy to Azure                 |
| `task strategy:destroy -- deployment-strategies/<reference-architecture>/<name>`       | Destroy one generated strategy deployment              |
| `task strategy:test:deployed -- deployment-strategies/<reference-architecture>/<name>` | Deploy, validate, and destroy one strategy             |
