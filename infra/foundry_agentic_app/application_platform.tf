# Keep the application platform explicit: registry and Container Apps environment are
# separate layers so derived solutions can keep both, replace one, or point at
